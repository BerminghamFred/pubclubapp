        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://twitter.com/pubclub" 
                className="text-[#08d78c] hover:text-white transition-colors duration-200"
                target="_blank"
              ...
              <a 
                href="https://instagram.com/pubclub" 
                className="text-[#08d78c] hover:text-white transition-colors duration-200"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a 
                href="https://facebook.com/pubclub" 
                className="text-[#08d78c] hover:text-white transition-colors duration-200"
                target="_blank"
                rel="noopener noreferrer"
              >
